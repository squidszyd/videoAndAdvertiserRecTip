...
**短视频和广告推荐场景涉及到对连续值的预估建模，如时长建模、GMV建模、流量ecpm和LTV等，如何对回归问题进行优化，主要有以下优化思路：**

1. 回归建模
优化方向：损失函数上做优化，不同的损失对数据有不同的先验分布假设，针对业务场景做出适配调整。

2. 回归转分类
优化方向：回归问题相比分类更加难以优化，难以学习，具体见：https://cloud.tencent.com/developer/news/60043，因此常采用将回归问题转为分类问题进行优化。
